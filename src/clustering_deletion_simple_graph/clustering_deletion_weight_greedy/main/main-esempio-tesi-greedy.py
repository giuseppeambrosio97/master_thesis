...
import time
from src.clustering_deletion_simple_graph.clustering_deletion_weight_greedy.clustering_deletion_edge_greedy import clustering_deletion_choice_edge_greedy
