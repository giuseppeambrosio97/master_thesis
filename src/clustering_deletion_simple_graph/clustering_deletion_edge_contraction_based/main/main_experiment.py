from src.clustering_deletion_edge_contraction_based.choice import choice_deleted_edge_greedy, choice_weight_greedy, choice_weight_softmax_random, choice_uniform_random, choice_weight_random, choice_entropy_greedy,choice_max_Ne0_e1
